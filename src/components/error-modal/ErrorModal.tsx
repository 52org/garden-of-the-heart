    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        <div className='min-h-screen px-4 text-center'>
          ...
          >
            <div
              className={`inline-block ${modalWidth} max-w-md mt-8 overflow-hidden text-left align-middle transition-all transform bg-white border border-gray-300 border-solid rounded-lg shadow-xl`}
            >
